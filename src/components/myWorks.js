...
const MyWorks = () => {
    return (
        <div className="container mt-5" id="MyWorks">
            ...
            <Work imagen = "/assets/img/personal.png" titulo = "Mi web" descripcion = "Pagina web desarrollada con la librería React. La idea de esta pagina es poder compartir mis proyectos e información de contacto." link = "https://github.com/rodrigorebolledo/web_personal2.0" categoria = "React"/>
            </div>
